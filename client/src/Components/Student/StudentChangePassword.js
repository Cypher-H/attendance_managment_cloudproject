...
function StudentChangePassword(props) {
    ...
    <div style={{marginLeft: 240}}>
      ...
      >
        ...
        <Button
          ...
          style={{ backgroundColor: "#00ffff", marginLeft: "70%" }}
          color="primary"
        >
          Change
        </Button>
...
export default connect(matchStateToProps)(StudentChangePassword);
